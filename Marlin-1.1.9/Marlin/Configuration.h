...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.06, 80.21, 402.00, 427.50 }
/**
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 575   // (ms) Enable and increase if needed
#endif
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -5.04   // Z offset: -below +above  [the nozzle]
